...
import { FaHome, FaInfoCircle, FaHandsHelping, FaEnvelope, FaSignInAlt, FaUserCircle, FaCog, FaSignOutAlt } from 'react-icons/fa'; // Importing React Icons
      ...
      <div className="container mx-auto flex items-center justify-between py-2 px-6">
        <div className="flex items-center space-x-3">
          <img 
            ...
            alt="Logo" 
            className="h-10 w-10 rounded-full transition-transform duration-300 hover:scale-110" // Reduced logo size
          />
          <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight">Mental Wellbeing</h1>
        </div>
        <nav>
          <ul className="flex items-center space-x-8">
            ...
            {isLoggedIn && (
              <li className="relative flex flex-col items-center justify-center space-y-1">
                ...
                >
                  <FaUserCircle className="text-2xl" /> {/* Increased size for the profile icon */}
            ...
            {!isLoggedIn && (
              <li>
                <button 
                  ...
                  className="text-white font-semibold transition-all duration-300 hover:text-pink-200 relative after:absolute after:bottom-[-2px] after:left-0 after:w-0 after:h-1 after:bg-white after:transition-all after:duration-300 hover:after:w-full flex flex-col items-center justify-center space-y-1"
                >
                  <span className="text-xl"><FaSignInAlt /></span> {/* Add a login icon here */}
